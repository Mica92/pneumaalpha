...
export const Route = createFileRoute("/_authenticated/comparar")({
  ...
  head: () => ({
    meta: [
      { title: "Comparar perspectivas — Kionas" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Comparar perspectivas — Kionas" },
      {
  ...
  return (
    <>
      ...
      <main className="route-enter relative z-10 overflow-hidden">
        ...
        <div className="relative mx-auto min-h-72 max-w-5xl px-5 pt-20 md:px-8 md:pt-28">
