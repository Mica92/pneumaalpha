...
export const Route = createFileRoute("/_authenticated/analisis")({
  ...
  head: () => ({
    meta: [
      { title: "Kionas — Análisis de textos, frases y conceptos" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Kionas — Análisis filosófico" },
      {
      ...
      { property: "og:url", content: `${SITE_URL}/analisis` },
      { property: "og:image", content: `${SITE_URL}/og-image.png` },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: `${SITE_URL}/og-image.png` },
    ],
    links: [{ rel: "canonical", href: `${SITE_URL}/analisis` }],
  }),
});
