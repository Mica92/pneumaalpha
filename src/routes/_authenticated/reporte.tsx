...
export const Route = createFileRoute("/_authenticated/reporte")({
  ...
  head: () => ({
    meta: [
      { title: "PneumAlpha — Reporte · espejo de tus conversaciones" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "PneumAlpha — Reporte" },
    ],
  }),
});
        ...
        {report && (
          <article className="fade-up mt-2 space-y-10">
            ...
            <section className="space-y-8">
              ...
              <ListBlock
                title={t("report.recommend.topics")}
                items={report.recommendations.topics}
              />
              <ListBlock
