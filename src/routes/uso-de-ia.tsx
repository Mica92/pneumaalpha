...
export const Route = createFileRoute("/uso-de-ia")({
  component: AiUsePage,
  head: () => {
    const title = "Política de uso aceptable de IA — Kionas";
    const description =
      "Cómo Kionas genera sus respuestas, qué usos están prohibidos, cómo moderamos el contenido y qué límites de seguridad aplicamos al diálogo filosófico.";
    return {
      meta: [
        { title },
...
const ES: LegalCopy = {
  ...
  sections: [
    ...
    },
    {
      ...
      p: "No reclamamos propiedad sobre los textos que escribes; conservas tus derechos y nos concedes una licencia limitada para procesarlos y prestarte el servicio. Los mensajes se envían a proveedores de modelos de lenguaje que actúan como encargados del tratamiento. Puedes exportar o eliminar tus conversaciones desde tu perfil o pidiéndolo a privacy@kionas.app. El detalle está en la Política de privacidad.",
    },
    {
      h: "9. Contacto",
      p: "Kionas IA · soporte@kionas.app · Santiago, Chile.",
    },
  ],
...
const EN: LegalCopy = {
  ...
  intro:
    "Kionas is an editorial and educational philosophy product operated by Kionas IA. Artificial intelligence is the interface that lets you study the thought of historical, public-domain authors; it is not a virtual companion, a general-purpose assistant, or a professional advice service. This policy explains how answers are generated, which uses are prohibited, and how we moderate the service.",
  sections: [
    {
      h: "1. How answers are generated",
      p: "Each Kionas “mind” is an editorial persona written by our team from the published work of a deceased, public-domain author (for example Heidegger, Kierkegaard, Arendt or the Stoics). We author a documented script — vocabulary, concerns, method, limits — and that script instructs a third-party language model that drafts the reply.\n\nThe result is a pedagogical interpretation, not a literal quotation or a statement by the real author. Answers are generated automatically and may be inaccurate; users always see the corresponding notice and should verify any material claim.",
    },
    {
