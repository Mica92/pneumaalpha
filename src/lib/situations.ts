...
export type Situation = {
  ...
  /** Tensiones que Kionas suele encontrar en esta situación. */
...
export const SITUATIONS: Situation[] = [
  {
    ...
    body: {
      es: "Cuando una decisión no avanza, rara vez falta información: suele faltar claridad sobre qué se está poniendo en juego. Kionas toma la decisión tal como la estás formulando, muestra los supuestos que la sostienen y la confronta con perspectivas que valorarían cosas distintas.",
      en: "When a decision stalls, information is rarely what is missing: what is missing is clarity about what is at stake. Kionas takes the decision as you are formulating it, shows the assumptions holding it up and sets it against perspectives that would value different things.",
    },
    tensions: [
  ...
  },
  {
    ...
    body: {
      es: "La pregunta casi nunca es solo laboral. Debajo suele haber ideas sobre identidad, libertad, riesgo y qué cuenta como una vida bien empleada. Kionas separa esas capas y te muestra cuál es la que realmente estás decidiendo.",
      en: "The question is almost never only about work. Underneath there are usually ideas about identity, freedom, risk and what counts as a well-spent life. Kionas separates those layers and shows you which one you are actually deciding.",
    },
    tensions: [
  ...
  },
  {
    ...
    body: {
      es: "Las relaciones se piensan mal cuando se discuten solo en términos de quién tiene razón. Kionas trabaja sobre lo que estás dando por supuesto: qué esperabas, qué reconoces en el otro y qué estás llamando amor, deber o costumbre.",
      en: "Relationships are thought through badly when they are argued only in terms of who is right. Kionas works on what you are assuming: what you expected, what you recognise in the other person and what you are calling love, duty or habit.",
    },
    tensions: [
  ...
  },
  {
    ...
    body: {
      es: "Buscar argumentos para una conclusión que ya tienes es distinto de examinarla. Kionas expone el supuesto que sostiene tu conclusión y lo pone frente a perspectivas que partirían de otro lugar, para que la decisión quede examinada y no solo defendida.",
      en: "Looking for arguments for a conclusion you already hold is different from examining it. Kionas exposes the assumption holding your conclusion up and sets it against perspectives that would start elsewhere, so the decision is examined and not only defended.",
    },
    tensions: [
    ...
    meta: {
      es: "Distinguir pensar de justificar: Kionas expone el supuesto detrás de una conclusión que ya tomaste.",
      en: "Tell thinking apart from justifying: Kionas exposes the assumption behind a conclusion you already reached.",
    },
  },
  {
    ...
    body: {
      es: "Sirve para una tesis, un argumento público, un texto ajeno o una convicción propia. Kionas identifica conceptos, supuestos y saltos, y contrasta la idea con tradiciones que la someterían a pruebas distintas.",
      en: "Useful for a thesis, a public argument, someone else's text or a conviction of your own. Kionas identifies concepts, assumptions and gaps, and contrasts the idea with traditions that would test it differently.",
    },
    tensions: [
  ...
  },
  {
    ...
    body: {
      es: "Un conflicto rara vez se resuelve repitiendo posiciones. Kionas separa la posición del supuesto que la sostiene y muestra dónde está la contradicción real, que casi nunca está donde se discute.",
      en: "A conflict is rarely resolved by repeating positions. Kionas separates the position from the assumption holding it up and shows where the real contradiction is, which is almost never where the argument happens.",
    },
    tensions: [
