...
export const GRAPH_NODES: GraphNode[] = [
  ...
  N("metaphysics_crit", "Crítica de la metafísica", "idea", "Las proposiciones metafísicas carecen de sentido verificable.", "Metaphysical propositions lack verifiable sense."),

  // ── Religiones y teologías ────────────────────────────────────────
  N("judaism", "Judaísmo", "religion", "Alianza, Torá y la escucha de un Dios que llama por su nombre.", "Covenant, Torah and listening to a God who calls by name."),
  N("christianity", "Cristianismo", "religion", "Encarnación, cruz y resurrección como centro de la historia.", "Incarnation, cross and resurrection as the centre of history."),
  N("catholicism", "Catolicismo", "religion", "Tradición, sacramento y magisterio en continuidad visible.", "Tradition, sacrament and magisterium in visible continuity."),
  N("orthodoxy", "Ortodoxia oriental", "religion", "Deificación (theosis), liturgia y teología apofática.", "Deification (theosis), liturgy and apophatic theology."),
  N("protestantism", "Protestantismo", "religion", "Sola fide, sola scriptura, conciencia ante Dios.", "Sola fide, sola scriptura, conscience before God."),
  N("islam", "Islam", "religion", "Tawhid: unicidad divina, revelación y ley.", "Tawhid: divine oneness, revelation and law."),
  N("hinduism", "Hinduismo", "religion", "Atman, Brahman, karma y liberación (moksha).", "Atman, Brahman, karma and liberation (moksha)."),
  N("buddhism", "Budismo", "religion", "Sufrimiento, origen dependiente y extinción del apego.", "Suffering, dependent origination and extinction of clinging."),
  N("taoism", "Taoísmo", "religion", "El Tao que no se nombra; actuar sin forzar (wu wei).", "The unnameable Tao; acting without forcing (wu wei)."),
  N("confucianism", "Confucianismo", "religion", "Ritual, piedad filial y cultivo del carácter.", "Ritual, filial piety and cultivation of character."),
  N("kabbalah", "Cábala", "religion", "Sefirot, tzimtzum y la reparación del mundo.", "Sefirot, tzimtzum and the repair of the world."),
  N("sufism", "Sufismo", "religion", "Vía mística del amor y la aniquilación en Dios.", "Mystical way of love and annihilation in God."),
  N("gnosticism", "Gnosticismo", "religion", "Salvación por conocimiento secreto; mundo como caída.", "Salvation through secret knowledge; world as fall."),
  N("neoplatonism_rel", "Neoplatonismo", "religion", "Emanación desde el Uno y retorno del alma.", "Emanation from the One and return of the soul.", "s. III–VI"),
  N("natural_theology", "Teología natural", "movement", "Camino racional hacia Dios desde el mundo.", "Rational path to God from the world."),
  N("negative_theology", "Teología negativa", "movement", "De Dios sólo puede decirse lo que no es.", "Of God one can only say what he is not."),
  N("liberation_theo", "Teología de la liberación", "movement", "Fe leída desde el pobre y la estructura social.", "Faith read from the poor and social structure.", "s. XX"),
  N("mysticism", "Mística", "movement", "Unión inmediata con lo divino más allá del concepto.", "Immediate union with the divine beyond concept."),
  N("secularization", "Secularización", "idea", "Desplazamiento de lo sagrado del centro público.", "Displacement of the sacred from the public centre."),
  N("theodicy", "Teodicea", "idea", "Justificar la bondad divina ante el mal.", "Justifying divine goodness in the face of evil."),
  N("sacred", "Lo sagrado", "idea", "Lo que se sustrae y a la vez funda.", "That which withdraws and at once founds."),
  N("transcendence", "Trascendencia", "idea", "Lo que excede el orden dado del mundo.", "What exceeds the given order of the world."),
  N("theosis", "Theosis", "idea", "El hombre llamado a participar de lo divino.", "Man called to participate in the divine."),
  N("revelation", "Revelación", "idea", "Verdad que se da y no se conquista.", "Truth that gives itself and is not conquered."),

  // ── Movimientos filosóficos ampliados ─────────────────────────────
  N("perennialism", "Filosofía perenne", "movement", "Un núcleo metafísico común late en todas las tradiciones.", "A common metaphysical core beats in every tradition."),
  N("traditionalism_sch", "Escuela tradicionalista", "movement", "Guénon, Coomaraswamy, Schuon: crítica del mundo moderno desde la Tradición.", "Guénon, Coomaraswamy, Schuon: critique of the modern world from Tradition.", "s. XX"),
  N("romanticism", "Romanticismo", "movement", "Genio, naturaleza, sentimiento y pueblo frente al cálculo.", "Genius, nature, feeling and people against calculation.", "s. XVIII–XIX"),
  N("hermeneutics", "Hermenéutica", "movement", "Comprender es siempre interpretar desde una tradición.", "To understand is always to interpret from a tradition."),
  N("positivism", "Positivismo", "movement", "Sólo el hecho verificable cuenta como conocimiento.", "Only the verifiable fact counts as knowledge.", "s. XIX"),
  N("logical_positivism", "Positivismo lógico", "movement", "Círculo de Viena: sentido = verificabilidad.", "Vienna Circle: meaning = verifiability.", "s. XX"),
  N("kantianism", "Kantismo", "movement", "Crítica de la razón: límites y condiciones del conocer.", "Critique of reason: limits and conditions of knowing."),
  N("neokantianism", "Neokantismo", "movement", "Marburgo y Baden: retorno a Kant frente al positivismo.", "Marburg and Baden: return to Kant against positivism.", "s. XIX–XX"),
  N("postmodernism", "Posmodernismo", "movement", "Incredulidad ante los grandes relatos.", "Incredulity towards grand narratives.", "s. XX"),
  N("deconstruction", "Deconstrucción", "movement", "Desmontar las oposiciones que sostienen el texto.", "Dismantling the oppositions that sustain the text."),
  N("critical_theory", "Teoría crítica", "movement", "Escuela de Frankfurt: razón instrumental y dominación.", "Frankfurt School: instrumental reason and domination.", "s. XX"),
  N("vitalism", "Vitalismo", "movement", "La vida como principio irreductible al mecanismo.", "Life as a principle irreducible to mechanism."),
  N("personalism", "Personalismo", "movement", "La persona como centro irreductible de valor.", "The person as irreducible centre of value."),
  N("thomism", "Tomismo", "movement", "Ser, analogía y ley natural en clave aristotélica.", "Being, analogy and natural law in Aristotelian key."),

  // ── Espectro político: izquierda, centro, derecha ─────────────────
  N("marxism_leninism", "Marxismo-leninismo", "ideology", "Vanguardia, partido y dictadura del proletariado.", "Vanguard, party and dictatorship of the proletariat."),
  N("anarcho_communism", "Anarcocomunismo", "ideology", "Comuna libre sin Estado ni propiedad privada.", "Free commune without state or private property."),
  N("democratic_socialism", "Socialismo democrático", "ideology", "Transformación social por vía electoral y sindical.", "Social transformation by electoral and union means."),
  N("progressivism", "Progresismo", "ideology", "Ampliación continua de derechos e igualdad.", "Continuous expansion of rights and equality."),
  N("green_politics", "Ecologismo político", "ideology", "Límite ecológico como criterio político central.", "Ecological limit as central political criterion."),
  N("feminism", "Feminismo", "ideology", "Crítica de la dominación patriarcal.", "Critique of patriarchal domination."),
  N("social_liberalism", "Liberalismo social", "ideology", "Libertad sostenida por condiciones materiales.", "Liberty sustained by material conditions."),
  N("christian_democracy", "Democracia cristiana", "ideology", "Persona, subsidiariedad y bien común.", "Person, subsidiarity and the common good."),
  N("centrism", "Centrismo", "ideology", "Moderación, pacto y rechazo del extremo.", "Moderation, compromise and rejection of extremes."),
  N("classical_liberalism", "Liberalismo clásico", "ideology", "Estado mínimo, propiedad y libre intercambio.", "Minimal state, property and free exchange."),
  N("libertarianism", "Libertarismo", "ideology", "Autopropiedad y no agresión como axiomas.", "Self-ownership and non-aggression as axioms."),
  N("neoliberalism", "Neoliberalismo", "ideology", "Mercado como forma general de gobierno.", "Market as the general form of government."),
  N("traditionalism_pol", "Tradicionalismo político", "ideology", "Orden heredado, religión y autoridad legítima.", "Inherited order, religion and legitimate authority."),
  N("reactionary", "Reaccionarismo", "ideology", "Restaurar un orden anterior perdido.", "Restoring a lost prior order."),
  N("nationalism", "Nacionalismo", "ideology", "La nación como sujeto político soberano.", "The nation as sovereign political subject."),
  N("populism", "Populismo", "ideology", "Pueblo contra élite como eje de lo político.", "People against elite as the axis of politics."),
  N("fascism", "Fascismo", "ideology", "Estado total, mito nacional y culto al líder.", "Total state, national myth and cult of the leader."),
  N("monarchism", "Monarquismo", "ideology", "Legitimidad dinástica y continuidad histórica.", "Dynastic legitimacy and historical continuity."),
  N("communitarianism", "Comunitarismo", "ideology", "El yo se forma en comunidades concretas.", "The self is formed in concrete communities."),
  N("integralism", "Integralismo", "ideology", "Orden político ordenado al fin religioso.", "Political order ordered to a religious end."),
  ...
  P("junger", "Ernst Jünger", "1895–1998", "La movilización total, el Trabajador y el rebelde del bosque.", "Total mobilisation, the Worker and the forest rebel.", "junger"),
  ...
  P("spengler", "Oswald Spengler", "1880–1936", "Culturas como organismos: la decadencia de Occidente.", "Cultures as organisms: the decline of the West.", "spengler"),
  ...
  N("sovereignty", "Soberanía", "idea", "Quien decide en última instancia.", "Who decides in the last instance."),
  N("equality", "Igualdad", "idea", "Igual consideración y reparto de poder.", "Equal consideration and distribution of power."),
  N("authority", "Autoridad", "idea", "Poder que se reconoce como legítimo.", "Power recognised as legitimate."),
  N("modernity", "Modernidad", "idea", "Sujeto, progreso y desencantamiento del mundo.", "Subject, progress and disenchantment of the world."),
  N("progress", "Progreso", "idea", "La historia como mejora acumulativa.", "History as cumulative improvement."),
  N("ideology_critique", "Crítica de la ideología", "idea", "Las ideas encubren intereses materiales.", "Ideas conceal material interests."),
  N("grand_narrative", "Gran relato", "idea", "Relato total que legitima el saber.", "Total narrative legitimising knowledge."),
  N("difference", "Diferencia (différance)", "idea", "El sentido se aplaza y nunca se cierra.", "Meaning defers itself and never closes."),
  N("interpretation", "Interpretación", "idea", "No hay hechos, sólo lecturas situadas.", "There are no facts, only situated readings."),
  N("common_good", "Bien común", "idea", "Fin compartido que excede la suma de intereses.", "Shared end exceeding the sum of interests."),
];
