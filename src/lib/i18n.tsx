...
export const T: Dict = {
  ...
  "oracle.card.title": {
    es: "Escribe lo que intentas comprender.",
  ...
  "oracle.page.title": {
    es: "¿Qué estás intentando comprender?",
  ...
  "oracle.result.enter": {
    es: "Explorar esta perspectiva →",
    en: "Explore this perspective →",
  },
  "oracle.result.again": { es: "Plantear otra pregunta", en: "Ask another question" },
  "oracle.error": {
    es: "No se pudo encontrar una perspectiva ahora. Intenta de nuevo en un momento.",
    en: "Couldn't find a perspective right now. Try again in a moment.",
  },
  "oracle.back": { es: "Volver al umbral", en: "Back to threshold" },

  "report.kicker": { es: "Retrato", en: "Portrait" },
  "report.card.title": {
    es: "Un retrato de tu pensamiento.",
    en: "A portrait of your thinking.",
  },
  "report.card.sub": {
    es: "Patrones observables en tus propias palabras: temas que vuelven, tensiones y qué leer ahora.",
    en: "Observable patterns in your own words: recurring themes, tensions and what to read next.",
  },
  "report.card.cta": { es: "Ver mi retrato →", en: "See my portrait →" },

  "report.page.title": {
    es: "Cómo piensas, según tus propias palabras.",
    en: "How you think, in your own words.",
  },
  "report.page.sub": {
    es: "Leo cómo escribes a cada perspectiva y describo patrones observables: temas que reaparecen, cómo argumentas, qué tensiones dejas abiertas. No es un diagnóstico ni una evaluación clínica: es una lectura de tus textos, con sugerencias de lectura.",
    en: "I read how you write to each perspective and describe observable patterns: recurring themes, how you argue, which tensions you leave open. This is not a diagnosis or a clinical assessment: it is a reading of your texts, with reading suggestions.",
  },
  "report.generate": { es: "Generar mi retrato", en: "Generate my portrait" },
  "report.running": { es: "Leyendo tus textos…", en: "Reading your texts…" },
