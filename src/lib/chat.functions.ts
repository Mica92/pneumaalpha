...
const PhilosopherSchema = z.enum(["heidegger", "schopenhauer", "james", "nietzsche", "marx", "bentham", "pohlenz", "einstein", "rationalism", "pascal", "kierkegaard", "yannaras", "levinas", "maimonides"]);
